...
Su questa definizione possiamo costruire molti spazi vettoriali, tra questi emergono gli spazi vettoriali composti da polinomi (con "+" identificato nella somma di polinomi e "\*" la moltiplicazione per uno scalare), le matrici (uno strumento matematico molto utile) e gli spazi di funzioni.